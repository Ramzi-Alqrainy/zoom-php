...
use ZoomPHP\Api\AbstractApi;
use ZoomPHP\HttpClient\Builder;
...
/**
 * Simple API wrapper for ZoomPHP.
 *
...
class ZoomPHPClient {
   ...
   *
   * @var ZoomPHP\HttpClient\Builder
   */
   ...
   *   The Zoom API secret.
   * @param ZoomPHP\HttpClient\Builder|null $httpClientBuilder
   *   The Http Client Builder.
   */
   ...
   *   The API name/class.
   *
   * @return ZoomPHP\AbstractApi|mixed
